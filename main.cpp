							...
							switch(pilsub2){
								...
								case 1:
								    ...
								    while (lagi == 1) {
									    ...
									    if (jml > prd[n].StokBrng) {
									        printf("\t\t\t\tStok barang tidak mencukupi. Silakan masukkan jumlah yang valid.\n");
									        continue; // Minta pembeli untuk menginput kembali jumlah barang
									    }
